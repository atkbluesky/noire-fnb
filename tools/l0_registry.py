...
SOURCES = [
    ...
    dict(
        ...
        name="Zalo OA export (legacy)", cadence="monthly", since="2026-01", required=False,
        pattern="OA Zalo T*.xls*", month_regex=MONTH_RX_T,
        example="OA Zalo T8.2026.xls",
        how="Nguồn đối soát/backfill lịch sử. M8.1 realtime dùng OpenAPI + Webhook; file .xls này không còn cấp số cho màn hình.",
        produces=["oa"], via="tools/build_month.py", modules=[],
    ),
    dict(
